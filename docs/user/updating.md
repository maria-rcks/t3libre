...
update buttons automatically resume active work after the replacement server is ready. Providers
with native promptless continuation use it; other providers receive a short instruction to continue
where they left off.
