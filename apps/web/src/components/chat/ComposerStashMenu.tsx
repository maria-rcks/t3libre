              ...
              entries.map((entry) => (
                ...
                >
                  ...
                  <Button
                    variant="ghost"
                    size="icon-xs"
                    className="pointer-events-none absolute top-1/2 right-2 z-10 -translate-y-1/2 bg-popover! text-foreground! opacity-0 shadow-none! transition-opacity hover:bg-popover! hover:text-foreground! group-hover/stash:pointer-events-auto group-hover/stash:opacity-100 group-focus-within/stash:pointer-events-auto group-focus-within/stash:opacity-100 focus-visible:pointer-events-auto focus-visible:bg-popover! focus-visible:text-foreground! focus-visible:opacity-100"
