...
const AgentSpawnCtaRow = memo(function AgentSpawnCtaRow(props: { workEntry: TimelineWorkEntry }) {
  ...
  return (
    <div className="-mx-1 rounded-xl border border-border/70 bg-secondary p-1.5 dark:border-transparent dark:bg-input/32">
  ...
  return (
    ...
    >
      ...
      {expanded && canExpand && expandedBody ? (
        ...
        >
          <pre className={cn(toolCallExpandedBodyClassName, isCommandEntry && "select-all")}>
            {expandedBody}
          </pre>
        </div>
      ) : null}
