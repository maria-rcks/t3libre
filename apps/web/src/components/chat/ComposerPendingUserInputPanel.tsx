    ...
    >
      ...
      <div className="px-1 sm:px-2">
        <CollapsibleTrigger
          ...
          className="group -my-1 flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left outline-none transition-colors duration-150 hover:bg-muted/35 focus-visible:ring-1 focus-visible:ring-primary/25"
        >
